	...
	_handleBookPort(latlngDevice) {
		...
		if (this.props.objBookport.typeBookport) {
			...
			api.autoBookport(infoBookport, (success, result, error) => {
				 ...
				 * 
				 * 1. Bookport khi tạo mới Phiếu Thông tin Khách hàng (bán thêm)
				 * 2. Bookport khi sửa lại từ Phiếu Thông tin Khách hàng (bán thêm) - sửa qua 3 bước info
				 * 3. Bookport khi sửa lại từ Phiếu Thông tin Khách hàng (bán thêm) - sửa thẳng
				*/
