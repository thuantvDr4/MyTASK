			...
			<View style={styles.wrapper}>
				...
				<View style={[{ paddingTop: Platform.OS === 'ios' ? 20 : 0, }]}>
					...
					<View style={styles.btnWrapper}>
						<TouchableOpacity onPress={this.writeToClipboard} style={[styles.btn, [this.state.isCopy ? styles.btnActive : '']]}>
							<Text style={[styles.btnTxt, [this.state.isCopy ? {color: "#fff"} : '']]} >{this.state.isCopy ? strings('imei.btn.copied') : strings('imei.btn.copy') }</Text>
						</TouchableOpacity>
					</View>
				</View>
			</View>
