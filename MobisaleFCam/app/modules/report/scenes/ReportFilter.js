...
class ReportFilter extends React.PureComponent {
    ...
    static navigationOptions = ({ navigation }) => {
        return {
            title: strings('report.filter.title'),
    ...
    _handleSubmit(){
        ...
        NavigationService.navigate('hideTabBottomReportList', {searchData : mySearch, onError : this.onError});
    }
...
ReportFilter.defaultProps = defaultProps;
export default connect()(ReportFilter)
