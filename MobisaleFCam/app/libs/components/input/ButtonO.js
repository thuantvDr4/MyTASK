	...
	render() {
		...
		return (
			<View style={[this.props.style]}>
				...
				>
					<Text style={[this.props.styleBtnText, validStyle.validStyleText]}>{this.props.label}</Text>
					{
						this.props && this.props.value 
						?
							<Text style={{color: '#898989', fontSize: 12, marginBottom: 5}}>{this.props.value}</Text>
						: 
							null
					}
